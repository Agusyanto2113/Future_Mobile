...
if(isset($_GET['id']) && isset($_GET['item_id']) && isset($_GET['sub_total'])){
...
?>
    ...
    <form action="" method="POST">
      ...
      ?>
        ...
        <input type="hidden" name="totalpurchase" value="<?php echo $totalpurchase; ?>">
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
      if (isset($_POST['orderinfosubmit'])){
          ...
          if($billname!="" && $billaddress !="" && $billemail!="" && $billingcity !="" && $billingstate !="" && $zipcode !=""){ 
